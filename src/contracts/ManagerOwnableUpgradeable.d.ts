...
interface ManagerOwnableUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ManagerOwnableUpgradeable extends BaseContract {
  ...
  interface: ManagerOwnableUpgradeableInterface;
